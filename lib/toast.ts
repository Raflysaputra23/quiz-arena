...
export const toastInfo = (text: string) => toast.error(text, { position: "top-right", style: { backgroundColor: "rgba(0,0,255,0.4)", backdropFilter: "blur(5px)", border: "1px solid rgba(0,0,255,0.6)", fontFamily: "var(--font-poppins)" } });